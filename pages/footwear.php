    ...
    <div class="container">
        ...
        <div class="filters">
            ...
            <div class="filter-group">
                ...
                <select name="size" class="filter-select" onchange="filterProducts()">
                    ...
                    <?php for ($i = 6; $i <= 12; $i++): ?>
                        <option value="<?php echo $i; ?>" <?php echo $size_filter == $i ? 'selected' : ''; ?>>
                            <?php echo $i; ?></option>
                    <?php endfor; ?>
                </select>
            </div>
        ...
        <?php if (empty($products)): ?>
            <div
                ...
                <p style="color: var(--color-gray); margin-bottom: 2rem;">We couldn't find any products matching your
                    current filters.</p>
...
$main_image = !empty($product['main_image']) ? $product['main_image'] : ($images[0] ?? 'placeholder.jpg');
